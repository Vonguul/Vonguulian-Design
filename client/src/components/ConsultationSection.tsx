  ...
  return (
    <section id="consultation" className="py-24 px-4 bg-secondary dark:bg-secondary">
      <div className="max-w-6xl mx-auto">
        ...
        >
          Expert <Link href="/resources" className="text-muted-foreground hover:text-primary hover:underline transition-colors" data-testid="link-guidance-resources">guidance</Link> tailored to your unique journey
        </p>
