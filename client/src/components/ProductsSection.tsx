...
export default function ProductsSection() {
  return (
    <section id="products" className="py-24 px-4 bg-white dark:bg-black">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <ProductCard
            ...
            description="Ideal for individuals want to focus on their own personal development *Recommended Purchase before Blueprint Consultation"
            price="$80"
            purchaseLink="#"
          />
        </div>
