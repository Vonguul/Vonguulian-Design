    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white">
      ...
      <main className="py-20 px-4">
        <div className="max-w-3xl mx-auto">
          <div className="bg-[#d9a520]/5 border border-[#d9a520]/20 rounded-lg p-8 md:p-12 text-center mb-10">
          ...
          <div className="border border-black/10 dark:border-white/10 rounded-lg p-8 mb-10">
          ...
          <div className="bg-black text-white rounded-lg p-6 md:p-8 text-center">
